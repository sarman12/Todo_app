...
//               <button className="group px-8 py-4 rounded-2xl border-2 border-slate-300 hover:border-slate-400 bg-white/80 backdrop-blur-sm font-semibold text-lg text-slate-700 hover:text-slate-900 transition-all duration-300 hover:shadow-xl transform hover:scale-105">
...
//         <span className="text-sm font-semibold text-white">Welcome to TaskFlow</span>
//       </div>
      
//       <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 leading-tight">
//         Transform Your
//         <span className="block mt-4 bg-gradient-to-r from-cyan-400 via-blue-400 to-emerald-400 bg-clip-text text-transparent">
//           Productivity Journey
//         </span>
//       </h1>
      
//       <p className="text-xl md:text-2xl text-white/80 mb-10 max-w-3xl mx-auto leading-relaxed">
//         Experience the future of task management with our intuitive platform designed 
...
//         <button 
//           onClick={() => navigate('/register')}
//           className="group relative bg-white text-slate-900 px-8 py-4 rounded-2xl font-semibold text-lg transform hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-3xl"
//         >
//           <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
...
//         <button className="group bg-transparent border-2 border-white/30 text-white px-8 py-4 rounded-2xl font-semibold text-lg hover:bg-white/10 transition-all duration-300 backdrop-blur-sm">
//           <span className="flex items-center space-x-2">
...
//       <ArrowRight className="w-6 h-6 text-white/60 transform rotate-90" />
//     </div>
//   </div>
// </section>
